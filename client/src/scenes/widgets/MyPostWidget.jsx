...
import { Box, Typography, Divider, InputBase, useTheme, Button, useMediaQuery, IconButton } from '@mui/material';
    ...
    return (
        <WidgetWrapper>
            ...
            <FlexBetween>
                ...
                <Button disabled={!post} onClick={handlePost} sx={{color: palette.background.main, borderRadius:"3rem"}}>
                    POST
                </Button>
            </FlexBetween>
        </WidgetWrapper>
